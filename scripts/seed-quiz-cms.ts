...
• Know exactly what to focus on each day 🎯`,
  ...
  // Info: Putting too much effort is not required!
  {
    ...
    description: "Too much effort can increase your burnout risk and hurt quality. Coachful tailors your plan to help you grow without overdoing it.",
    ctaLabel: 'Got it →',
  ...
  // Info: Creators who sell
  {
    ...
    description: "Coachful helps you balance value content with simple offers, instead of posting endlessly for free. Your content should work for you, not just your audience.",
    ctaLabel: 'Got it ➜',
  ...
  // Step 26 - Info: Authority/proof
  {
    ...
    description: "Coachful has worked with creators who started from 0–2k followers, were juggling full-time work, and used structure + accountability to finally become consistent.\n\nYou're in good company.",
