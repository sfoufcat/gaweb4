          ...
          {!suggestionLoading && suggestion?.suggestion && !text.trim() && (
            ...
            >
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-4 py-2.5 bg-gradient-to-r from-[#a07855]/10 to-[#8c6245]/5 hover:from-[#a07855]/20 hover:to-[#8c6245]/10 border border-[#a07855]/20 rounded-full transition-all hover:scale-[1.02] active:scale-[0.98]"
              >
