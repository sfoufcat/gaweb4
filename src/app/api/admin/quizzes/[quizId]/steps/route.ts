/**
 * Admin API: Quiz Steps Management
 * 
 * GET /api/admin/quizzes/:quizId/steps - List all steps for a quiz
 * POST /api/admin/quizzes/:quizId/steps - Create new step
 * 
...
import type { QuizStep, QuizStepCreateRequest, QuizStepWithOptions, QuizOption, ClerkPublicMetadata } from '@/types';
...
export async function GET(
  ...
  try {
    ...
    console.error('[ADMIN_QUIZ_STEPS_GET] Error:', error);
...
export async function POST(
  ...
  try {
    ...
    const stepData = {
      ...
      // Goal and starting point fields
    ...
    console.log(`[ADMIN_QUIZ_STEPS_POST] Created step for quiz ${quizId}: ${stepRef.id}`);
    ...
    console.error('[ADMIN_QUIZ_STEPS_POST] Error:', error);
    return NextResponse.json(
