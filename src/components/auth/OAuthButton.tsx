  ...
  return (
    <button
      ...
      className={`
        ...
        focus:outline-none focus:ring-2 focus:ring-brand-accent dark:ring-brand-accent/20 focus:border-brand-accent
    ...
    >
      {loading ? (
        <div className="w-5 h-5 border-2 border-text-secondary/30 border-t-text-primary rounded-full animate-spin" />
      ) : (
        <Icon />
      )}
      <span>{label}</span>
