            ...
            <div className="space-y-3">
              {domainsWithUrls.map(domain => (
                <a
                  ...
                  className="flex items-center gap-4 p-4 bg-white dark:bg-[#171b22] rounded-xl border border-[#e1ddd8] dark:border-[#2a2f38] hover:border-[#a07855] dark:hover:border-[#a07855] transition-colors group"
                >
                  {/* Org logo */}
                  ...
                  {/* Arrow */}
                  <ExternalLink className="w-5 h-5 text-text-secondary group-hover:text-[#a07855] transition-colors flex-shrink-0" />
                </a>
              ))}
            </div>
          </div>
