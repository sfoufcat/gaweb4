  ...
  return (
    <div className="pt-6 pb-32">
      ...
      <div className="mt-8 pt-8 border-t border-[#e1ddd8]/50 dark:border-[#262b35]/50">
        <Link
          href="/discover"
          className="group flex items-center justify-between p-5 bg-brand-accent-subtle border border-brand-accent-subtle hover:border-brand-accent rounded-[20px] hover:shadow-lg transition-all duration-300"
        >
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-full bg-brand-accent flex items-center justify-center flex-shrink-0">
              <Sparkles className="w-6 h-6 text-brand-accent-foreground" />
            </div>
            <div>
          ...
          <div className="flex-shrink-0 w-10 h-10 rounded-full bg-brand-accent flex items-center justify-center group-hover:opacity-90 group-hover:scale-105 transition-all">
            <ArrowRight className="w-5 h-5 text-brand-accent-foreground" />
          </div>
        </Link>
      </div>
    </div>
