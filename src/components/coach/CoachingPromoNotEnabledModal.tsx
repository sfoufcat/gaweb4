...
export function CoachingPromoNotEnabledModal({
  ...
  const modalContent = (
    <div className="flex flex-col bg-white dark:bg-[#171b22] overflow-hidden">
      {/* Close Button */}
      <button
        onClick={onClose}
        className="absolute top-4 right-4 p-1.5 text-text-secondary hover:text-text-primary dark:text-[#b2b6c2] dark:hover:text-[#f5f5f8] transition-colors z-10"
      >
        <X className="w-5 h-5" />
      </button>
      ...
      <Dialog as="div" className="relative z-[10000]" onClose={onClose}>
        ...
        <div className="fixed inset-0 z-[10001] overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4">
            ...
            >
              <Dialog.Panel className="relative w-full max-w-md transform overflow-hidden rounded-2xl bg-white dark:bg-[#171b22] shadow-2xl shadow-black/10 dark:shadow-black/30 transition-all">
                {modalContent}
              </Dialog.Panel>
            </Transition.Child>
          </div>
