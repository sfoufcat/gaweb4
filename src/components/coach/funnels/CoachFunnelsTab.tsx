      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="p-2 sm:px-2.5 sm:py-1.5 text-[#6b6560] dark:text-[#9ca3af] hover:bg-[#ebe8e4] dark:hover:bg-[#262b35] hover:text-[#1a1a1a] dark:hover:text-white rounded-lg transition-colors duration-200 flex items-center gap-2"
          >
            <Code className="w-4 h-4" />
            <span className="hidden sm:inline text-[15px] font-medium">Pixels</span>
          </button>
          {/* New Funnel Button */}
          <button
            onClick={() => {
