      ...
      <div className="bg-white border border-[#e1ddd8] rounded-xl overflow-hidden">
        ...
        <div className="p-4">
          <button
            ...
            className="w-full py-3 border-2 border-dashed border-[#e1ddd8] rounded-xl text-text-secondary hover:border-brand-accent hover:text-brand-accent transition-colors flex items-center justify-center gap-2"
          >
                      ...
                      <button
                        ...
                        className={`p-4 border rounded-xl transition-colors text-left relative ${
                          isAllowed && !isLimitReached
                            ? 'border-[#e1ddd8] hover:border-brand-accent hover:bg-[#faf8f6] disabled:opacity-50'
