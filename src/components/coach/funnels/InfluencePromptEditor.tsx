    ...
    <div className="border-t border-[#e1ddd8] dark:border-[#262b35] pt-6 mt-6">
      ...
      {!hasPrompt && !selectingType && (
        <button
          ...
          className="w-full py-4 border-2 border-dashed border-[#e1ddd8] dark:border-[#262b35] rounded-xl text-text-secondary dark:text-[#b2b6c2] hover:border-brand-accent hover:text-brand-accent transition-colors flex items-center justify-center gap-2 font-albert"
        >
              ...
              {INFLUENCE_TYPES.map((typeInfo) => {
                ...
                return (
                  <button
                    ...
                    className="p-4 rounded-xl border-2 border-[#e1ddd8] dark:border-[#262b35] hover:border-brand-accent transition-all text-left group"
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <h5 className="font-albert font-semibold text-text-primary dark:text-[#f5f5f8] group-hover:text-brand-accent transition-colors">
                          {typeInfo.label}
                        </h5>
              ...
              <div className="flex items-center justify-between p-3 bg-[#faf8f6] dark:bg-[#1a1f28] rounded-xl mb-4">
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="text-xs text-brand-accent hover:text-brand-accent/90 font-medium"
                  >
                    Change
                  </button>
                  <button
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <input
                      ...
                      className="flex-1 px-4 py-2 border border-[#e1ddd8] dark:border-[#262b35] dark:bg-[#11141b] rounded-lg focus:outline-none focus:border-brand-accent dark:text-[#f5f5f8] font-albert text-sm"
                    />
                    {value?.accentColor && (
                      <button
                        type="button"
    ...
    <div className="space-y-4 p-4 bg-[#faf8f6] dark:bg-[#1a1f28] rounded-xl">
      ...
      <div>
        ...
        <textarea
          ...
          rows={3}
          className="w-full px-4 py-2 border border-[#e1ddd8] dark:border-[#262b35] dark:bg-[#11141b] rounded-lg focus:outline-none focus:border-brand-accent dark:text-[#f5f5f8] font-albert resize-none"
        />
      </div>
