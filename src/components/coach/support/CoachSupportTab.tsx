      ...
      <section className="bg-white/60 dark:bg-[#171b22]/60 backdrop-blur-xl border border-[#e1ddd8] dark:border-[#262b35]/50 rounded-2xl overflow-hidden">
        <div className="p-6">
          <div className="flex items-start gap-4 mb-6">
            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-brand-accent/10 to-[#8c6245]/5 dark:from-[#b8896a]/20 dark:to-brand-accent/10 flex items-center justify-center flex-shrink-0">
          ...
          <div className="flex items-center gap-3 p-4 bg-[#faf8f6] dark:bg-[#262b35] rounded-xl mb-6">
            ...
            <div>
              ...
              <a 
                ...
                className="text-brand-accent font-albert font-semibold hover:underline"
              >
                {SUPPORT_EMAIL}
              </a>
            </div>
