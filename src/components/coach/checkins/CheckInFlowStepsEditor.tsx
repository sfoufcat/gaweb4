      ...
      <div className="bg-white dark:bg-[#171b22] border border-[#e1ddd8] dark:border-[#262b35] rounded-xl overflow-hidden">
        ...
        <div className="p-4">
          <button
            ...
            className="w-full py-3 border-2 border-dashed border-[#e1ddd8] dark:border-[#262b35] rounded-xl text-text-secondary dark:text-[#b2b6c2] hover:border-[#a07855] hover:text-[#a07855] dark:hover:border-[#b8896a] dark:hover:text-[#b8896a] transition-colors flex items-center justify-center gap-2"
          >
                  ...
                  {ADDABLE_STEP_TYPES.map((type) => {
                    ...
                    return (
                      <button
                        ...
                        disabled={isSaving}
                        className="p-4 border border-[#e1ddd8] dark:border-[#262b35] rounded-xl hover:border-[#a07855] dark:hover:border-[#b8896a] hover:bg-[#faf8f6] dark:hover:bg-[#1a1f28] transition-colors text-left disabled:opacity-50"
                      >
