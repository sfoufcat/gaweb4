    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <input
          ...
          className="w-full px-4 py-2.5 bg-white dark:bg-[#0d1015] border border-[#e1ddd8] dark:border-[#262b35] rounded-xl text-text-primary dark:text-[#f5f5f8] placeholder:text-text-muted dark:placeholder:text-[#666d7c] focus:outline-none focus:border-[#a07855] dark:focus:border-[#b8896a]"
        />
      </div>
              ...
              {EMOJI_OPTIONS.map((emoji) => (
                <button
                  ...
                  className={`p-2 text-xl rounded-xl transition-all ${
                    config.icon === emoji
                      ? 'bg-[#a07855]/20 scale-110 ring-2 ring-[#a07855]'
            ...
            <button
              ...
              className={`h-10 rounded-lg bg-gradient-to-br ${preset.value} transition-all ${
                config.gradient === preset.value
                  ? 'ring-2 ring-[#a07855] ring-offset-2 ring-offset-white dark:ring-offset-[#171b22] scale-105'
                  : 'hover:scale-105'
              }`}
            />
          ))}
