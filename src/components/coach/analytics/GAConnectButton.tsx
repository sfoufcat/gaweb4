            ...
            <div className="px-6 py-4">
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 rounded-lg border border-[#e1ddd8] dark:border-[#262b35] bg-white dark:bg-[#11141b] text-[#1a1a1a] dark:text-[#f5f5f8] font-mono text-sm focus:outline-none focus:ring-2 focus:ring-brand-accent/30 dark:focus:ring-brand-accent/30"
                />
            ...
            <div className="flex items-center justify-between px-6 py-4 border-t border-[#e1ddd8] dark:border-[#262b35]">
              ...
              <div className={`flex gap-3 ${!isConfigured ? 'ml-auto' : ''}`}>
                ...
                <button
                  onClick={handleSave}
                  disabled={saving}
                  className="px-4 py-2 rounded-lg text-sm font-medium bg-brand-accent text-white hover:bg-brand-accent/90 transition-colors disabled:opacity-50 flex items-center gap-2"
                >
                  {saving ? (
                    <>
