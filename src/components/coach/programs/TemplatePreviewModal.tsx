      ...
      <div className="flex-1 overflow-y-auto px-6 py-6">
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <button onClick={() => window.location.reload()} className="text-[#a07855] text-sm hover:underline">
              Try again
            </button>
          </div>
        ) : (
      ...
      <div className="px-6 py-4 border-t border-[#e1ddd8] dark:border-[#262b35] bg-white dark:bg-[#171b22]">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            disabled={loading}
            className="px-6 py-3 rounded-xl bg-[#a07855] hover:bg-[#8c6245] dark:bg-[#b8896a] dark:hover:bg-[#a07855] text-white font-semibold font-albert transition-colors disabled:opacity-50 flex items-center gap-2"
          >
            Use This Template
