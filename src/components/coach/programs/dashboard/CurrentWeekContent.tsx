...
import { BookOpen, GraduationCap, FileText, ChevronRight } from 'lucide-react';
            ...
            <div className="space-y-2">
              {modules.map((module) => {
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <TaskCheckbox isCompleted={isComplete} size="md" />
                    ...
                    {module.lessons.length > 0 && (
                      <div className="mt-2 pl-9 space-y-1">
                        {module.lessons.map((lesson) => (
                          ...
                          >
                            <TaskCheckbox isCompleted={lesson.completed} size="sm" />
                            <span
                              className={cn(
                                'text-xs truncate',
                                lesson.completed
          ...
          <div>
            ...
            <div className="space-y-2">
              {articles.map((article) => (
                ...
                >
                  <TaskCheckbox isCompleted={article.completed} size="md" />
                  <span
                    className={cn(
