...
import { Loader2, Settings2, User, Calendar, Infinity } from 'lucide-react';
        ...
        <DrawerHeader className="px-6 pt-2 pb-4 border-b border-[#e8e5e1] dark:border-[#262b35]">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-[#f3f1ef] dark:bg-[#262b35] flex items-center justify-center">
              <Settings2 className="w-5 h-5 text-[#5f5a55] dark:text-[#b2b6c2]" />
            </div>
            <div>
              ...
              <DrawerDescription className="text-sm text-[#5f5a55] dark:text-[#b2b6c2] font-albert">
                Control program combinations for enrollment.
              </DrawerDescription>
            </div>
          </div>
        </DrawerHeader>
