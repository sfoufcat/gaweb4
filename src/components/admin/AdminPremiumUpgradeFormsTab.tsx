      ...
      <div className="bg-white/60 dark:bg-[#171b22]/60 backdrop-blur-xl border border-[#e1ddd8] dark:border-[#262b35]/50 rounded-2xl p-6 animate-pulse">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="space-y-2">
            <div className="h-6 w-36 bg-[#e1ddd8]/50 dark:bg-[#272d38]/50 rounded" />
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <div className="relative">
              <input
                ...
                className="w-72 px-3 py-2 pl-9 border border-[#e1ddd8] dark:border-[#262b35] rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-accent dark:ring-brand-accent font-albert text-sm"
              />
              <svg
