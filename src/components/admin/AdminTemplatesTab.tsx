    ...
    <div className="space-y-6">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-12 pr-4 py-3 rounded-xl border border-[#e1ddd8] dark:border-[#262b35] bg-white dark:bg-[#171b22] text-[#1a1a1a] dark:text-[#f5f5f8] font-albert placeholder:text-[#a7a39e] focus:outline-none focus:ring-2 focus:ring-[#a07855]/30"
        />
      </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-20">
          ...
          <button onClick={fetchTemplates} className="text-[#a07855] text-sm mt-2 hover:underline">
            Try again
          </button>
        </div>
  ...
  return (
    <button
      ...
      className={`p-4 rounded-xl border transition-all text-left ${
        active 
          ? 'border-[#a07855] dark:border-[#b8896a] ring-2 ring-[#a07855]/20' 
          : color 
            ? colorStyles[color] 
            : 'bg-white dark:bg-[#171b22] border-[#e1ddd8] dark:border-[#262b35]'
      } hover:border-[#a07855]/50`}
    >
