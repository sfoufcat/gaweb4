      ...
      <AlertDialogContent className="max-w-md p-0">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div className="flex items-start gap-3 p-4 bg-[#faf8f6] rounded-[16px]">
            <Key className="w-5 h-5 text-brand-accent mt-0.5 flex-shrink-0" />
          ...
          <div>
            ...
            <input
              ...
              maxLength={12}
              className="w-full px-4 py-4 bg-white border border-[#e1ddd8] rounded-[12px] font-mono text-[18px] text-text-primary text-center tracking-[2px] placeholder:text-text-secondary/40 focus:outline-none focus:ring-2 focus:ring-brand-accent dark:ring-brand-accent/30 focus:border-brand-accent transition-all uppercase"
              autoFocus
            />
          </div>
          ...
          <div className="pt-2">
            <Button
              ...
              className="w-full bg-brand-accent hover:bg-brand-accent/90 disabled:bg-brand-accent/50 text-white rounded-[16px] py-3 font-albert font-semibold text-[16px]"
            >
              {loading ? (
