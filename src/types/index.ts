...
export interface ProgramTaskTemplate {
  ...
  dayTag?: 'auto' | 'spread' | 'daily' | number | number[]; // 'auto' = use program distribution, 'spread' = force spread, 'daily' = all days, number = specific day (1-7), number[] = multiple specific days
