...
export const proxy = clerkMiddleware(async (auth, request) => {
  ...
  if (isMarketingDomain(hostname)) {
    ...
    const isAllowedRoute = 
      ...
      pathname.startsWith('/onboarding') ||            // User onboarding (prevents redirect loops)
      ...
      pathname.startsWith('/coach/plan') ||            // Coach plan selection (for reactivation)
      pathname.startsWith('/coach/reactivate') ||      // Coach subscription reactivation
  ...
  const isFullscreenPage =
    ...
    pathname.startsWith('/q/') ||  // Questionnaire fill pages - full-screen, no sidebar
